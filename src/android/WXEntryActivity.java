package com.busll.quzhouxing.wxapi;
...
public class WXEntryActivity extends Activity implements IWXAPIEventHandler {
    ...
    public void onResp(BaseResp resp) {
        Log.d(NativeWebView.LOG_TAG, resp.toString());
        ...
        switch (resp.errCode) {
            ...
            case BaseResp.ErrCode.ERR_USER_CANCEL:
                ctx.error(NativeWebView.ERROR_WECHAT_RESPONSE_USER_CANCEL);
                break;
            case BaseResp.ErrCode.ERR_AUTH_DENIED:
                ctx.error(NativeWebView.ERROR_WECHAT_RESPONSE_AUTH_DENIED);
                break;
            case BaseResp.ErrCode.ERR_SENT_FAILED:
                ctx.error(NativeWebView.ERROR_WECHAT_RESPONSE_SENT_FAILED);
                break;
            case BaseResp.ErrCode.ERR_UNSUPPORT:
                ctx.error(NativeWebView.ERROR_WECHAT_RESPONSE_UNSUPPORT);
                break;
            case BaseResp.ErrCode.ERR_COMM:
                ctx.error(NativeWebView.ERROR_WECHAT_RESPONSE_COMMON);
                break;
            default:
                ctx.error(NativeWebView.ERROR_WECHAT_RESPONSE_UNKNOWN);
                break;
        }
    ...
    protected void auth(BaseResp resp) {
        ...
        Log.d(NativeWebView.LOG_TAG, res.toString());
        ...
        try {
            ...
            Log.e(NativeWebView.LOG_TAG, e.getMessage());
        }
